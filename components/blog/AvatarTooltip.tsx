      ...
      {persons.map((person, _idx) => (
        ...
        >
          ...
          <Image
            ...
            alt={person.name}
            className="border-primary-light relative !m-0 size-14 rounded-full border-2 object-cover object-top !p-0 transition duration-500 group-hover:z-30 group-hover:scale-105 lg:size-20"
          />
        </Link>
      ))}
      {persons.length > 8 && (
